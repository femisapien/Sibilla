...
cd('C:\101510\')
ipath='database/';sectype='STOCKSD';listname='dListDEMO'; 

updq=1;%to create a new DB from the beginning use only sold and enew
type='D'; %asset classes
...
out=xMRC2026(0,reports,ipath,sectype,sold,eold,snew,enew,listname,updq,type)
...
%% MASTER
reports=1;%run complete set of reports
ipath='database/';sectype='STOCKSD';listname='dListDEMO'; %dListMASTER2025
...
out=xMRC2026(1,reports,ipath,sectype,sold,eold,snew,enew,listname,updq,type)

status = WriteOutImproved(db_path, 'STOCKSD', enew, 'SRD')
